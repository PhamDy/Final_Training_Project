...
export class CategoryService {
  ...
  getCategoryById(Id: string): Observable<Category> {
    return this.http.get<Category>(`${urlPublic + endPoint + 'category' + '/' + Id}`);
  }

  addCategory(category: Category): Observable<void> {
    return this.http.post<void>(`${urlPrivate + endPoint + 'saveCategory'}`,
      category
    );
  }

  updateCategory(id: string, category: Category): Observable<void> {
    return this.http.put<void>(`${urlPrivate + endPoint + 'category' + '/' + id}`,
      category
    );
  }

  deleteCategory(id: number): Observable<void> {
    return this.http.delete<void>(`${urlPrivate + endPoint + 'category' + '/' + id}`);
  }
